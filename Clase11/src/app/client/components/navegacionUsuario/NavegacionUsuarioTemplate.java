...
public class NavegacionUsuarioTemplate extends JPanel{
    ...
    public void crearObjetosDecoradores(){
        ...
        this.iIconoUsuario = new ImageIcon("Clase11/resources/img/usuario_navegacion.png");
        this.iInicio = new ImageIcon("Clase11/resources/img/inicio.png");
        this.iPerfil = new ImageIcon("Clase11/resources/img/perfil.png");
        this.iAmigos = new ImageIcon("Clase11/resources/img/amigos.png");
        this.iProductos = new ImageIcon("Clase11/resources/img/productos.png");
        this.iConfiguracion = new ImageIcon("Clase11/resources/img/configuracion.png");
        this.iCerrarSesion = new ImageIcon("Clase11/resources/img/salir.png");
    }
