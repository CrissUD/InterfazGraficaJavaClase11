...
public class NavegacionUsuarioTemplate extends JPanel {
  ...
  public void crearObjetosDecoradores() {
    this.iIconoUsuario = new ImageIcon("Clase11/resources/images/usuario_navegacion.png");
    this.iInicio = new ImageIcon("Clase11/resources/images/inicio.png");
    this.iPerfil = new ImageIcon("Clase11/resources/images/perfil.png");
    this.iAmigos = new ImageIcon("Clase11/resources/images/amigos.png");
    this.iProductos = new ImageIcon("Clase11/resources/images/productos.png");
    this.iConfiguracion = new ImageIcon("Clase11/resources/images/configuracion.png");
    this.iCerrarSesion = new ImageIcon("Clase11/resources/images/salir.png");
