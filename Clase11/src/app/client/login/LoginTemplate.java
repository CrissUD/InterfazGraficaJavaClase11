...
public class LoginTemplate extends JFrame {
    ...
    public void crearObjetosDecoradores(){
        ...
        iFondo = new ImageIcon("Clase11/resources/img/fondo.png");
        iLogo = new ImageIcon("Clase11/resources/img/logo.png");
        iUsuario = new ImageIcon("Clase11/resources/img/usuario.png");
        iClave = new ImageIcon("Clase11/resources/img/clave.png");
        iPunto = new ImageIcon("Clase11/resources/img/punto.png");
        iFacebook = new ImageIcon("Clase11/resources/img/facebook.png");
        iTwitter = new ImageIcon("Clase11/resources/img/twitter.png");
        iYoutube = new ImageIcon("Clase11/resources/img/youtube.png");
        iSvg = new ImageIcon("Clase11/resources/img/imagen.png");
    }
